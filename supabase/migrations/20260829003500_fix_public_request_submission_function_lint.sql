-- MAP-056 follow-up: SQL-language special expressions such as COALESCE and
-- NULLIF cannot be schema-qualified. Recreate the authoritative public ingress
-- with the same signature/security contract and lint-clean expressions.
