...
for (const viewport of PORTRAIT_VIEWPORTS) {
  test(`keeps the map first and controls compact at ${viewport.width}px`, async ({ page }, testInfo) => {
...
test('runs the MAP-033 suite with Android Chromium and iOS WebKit emulation', async ({ page }, testInfo) => {
