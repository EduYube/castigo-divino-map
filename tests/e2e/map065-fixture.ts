...
export const MAP065_ROWS: Readonly<Record<string, readonly Record<string, unknown>[]>> = {
  ...
  categories: [
    {
      id: 'category-map065-character',
      slug: 'map065-character',
      name: 'Personajes MAP065',
      description: '',
    },
    {
      id: 'category-map065-location',
      slug: 'map065-location',
      name: 'Emplazamientos MAP065',
      description: '',
    },
    {
      id: 'category-map065-region',
      slug: 'map065-region',
      name: 'Regiones MAP065',
      description: '',
    },
    {
      id: 'category-map065-mission',
      slug: 'map065-mission',
      name: 'Misiones MAP065',
      description: '',
    },
    {
      id: 'category-map065-hazard',
      slug: 'map065-hazard',
      name: 'Peligros MAP065',
      description: '',
    },
  ],
  ...
  map_entities: [
    {
      id: MAP065_IDS.character,
      slug: 'map065-character',
      entity_type: 'character',
      lifecycle_status: null,
      visibility: 'pin',
      name: 'Personaje MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
      geometry: { kind: 'point', coordinates: { x: 500, y: 400 } },
      x: 500,
      y: 400,
      category_id: 'category-map065-character',
    },
    {
      id: MAP065_IDS.location,
      slug: 'map065-location',
      entity_type: 'location',
      lifecycle_status: null,
      visibility: 'pin',
      name: 'Emplazamiento MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
      geometry: { kind: 'point', coordinates: { x: 900, y: 700 } },
      x: 900,
      y: 700,
      category_id: 'category-map065-location',
    },
    {
      id: MAP065_IDS.region,
      slug: 'map065-region',
      entity_type: 'location',
      lifecycle_status: null,
      visibility: 'pin',
      ...
      x: 1450,
      y: 850,
      category_id: 'category-map065-region',
    },
    {
      id: MAP065_IDS.mission,
      slug: 'map065-mission',
      entity_type: 'mission',
      lifecycle_status: 'completed',
      visibility: 'pin',
      name: 'Misión completada MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
      geometry: { kind: 'point', coordinates: { x: 2050, y: 800 } },
      x: 2050,
      y: 800,
      category_id: 'category-map065-mission',
    },
    {
      id: MAP065_IDS.hazard,
      slug: 'map065-hazard',
      entity_type: 'hazard',
      lifecycle_status: 'resolved',
      visibility: 'pin',
      name: 'Peligro resuelto MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
      geometry: { kind: 'point', coordinates: { x: 2500, y: 1100 } },
      x: 2500,
      y: 1100,
      category_id: 'category-map065-hazard',
    },
    {
      id: MAP065_IDS.clusterCharacter,
      slug: 'map065-cluster-character',
      entity_type: 'character',
      lifecycle_status: null,
      visibility: 'pin',
      name: 'Personaje agrupado MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
      geometry: { kind: 'point', coordinates: { x: 3000, y: 1500 } },
      x: 3000,
      y: 1500,
      category_id: 'category-map065-character',
    },
    {
      id: MAP065_IDS.clusterMission,
      slug: 'map065-cluster-mission',
      entity_type: 'mission',
      lifecycle_status: 'active',
      visibility: 'pin',
      name: 'Misión agrupada MAP065',
      name_language: 'en',
      summary: '',
      description: '',
      portrait_path: null,
...
export async function configureMap065Backend(
  page: Page,
  initialMode: Map065BackendMode = 'success',
) {
  ...
  return {
    setMode(nextMode: Map065BackendMode) {
      mode = nextMode;
    },
  };
}
