...
REQUIRED_OPTIONS=(
  ...
  "Type|Research" "Type|Feature" "Type|Chore"
  "Area|Governance" "Area|Backend" "Area|Data" "Area|Auth" "Area|Admin"
  "Area|Search" "Area|Map" "Area|UI" "Area|Quality" "Area|Delivery"
...
# map_id|issue|status|priority|type|area|estimate|target
PROJECT_ITEMS=(
  "013|32|Ready|P0|Research|Governance|5|Beta 0.2"
  "014|33|Backlog|P0|Feature|Backend|8|Beta 0.2"
  "015|34|Backlog|P0|Feature|Data|8|Beta 0.2"
  "016|35|Backlog|P0|Feature|Backend|8|Beta 0.2"
  "017|36|Backlog|P0|Feature|Auth|5|Beta 0.2"
  "018|37|Backlog|P0|Feature|Admin|8|Beta 0.2"
  "019|38|Backlog|P0|Feature|Admin|8|Beta 0.2"
  "020|39|Backlog|P0|Feature|Data|5|Beta 0.2"
  "021|40|Backlog|P0|Feature|Search|5|Beta 0.2"
  "022|41|Backlog|P1|Feature|Map|5|Beta 0.2"
  "023|42|Backlog|P1|Feature|UI|3|Beta 0.2"
  "024|43|Backlog|P0|Feature|UI|5|Beta 0.2"
  "025|44|Backlog|P1|Feature|UI|3|Beta 0.2"
  "026|45|Backlog|P1|Feature|UI|5|Beta 0.2"
  "027|46|Backlog|P1|Feature|Admin|5|Beta 0.2"
  "028|47|Backlog|P0|Chore|Data|5|Beta 0.2"
  "029|48|Backlog|P0|Chore|Quality|8|Beta 0.2"
  "030|49|Backlog|P0|Chore|Delivery|5|Beta 0.2"
)

for entry in "${PROJECT_ITEMS[@]}"; do
  IFS='|' read -r map_id issue_number status priority type area estimate target <<<"$entry"
  ...
  echo "Configurada MAP-${map_id} (#${issue_number})."
done

echo
echo "Backlog Beta 0.2 configurado correctamente: https://github.com/users/${OWNER}/projects/${PROJECT_NUMBER}"
